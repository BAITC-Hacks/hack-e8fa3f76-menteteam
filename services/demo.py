...
def demo_meeting():
    segments = [
        ...
        Segment(id="seg-4", speaker="SPEAKER_01", start=19, end=27,
                text="По финансам освоено 68% бюджета. Проблема — подрядчики задерживают счета."),
    ]
    result = build_result("Демо • Русский + қазақша", segments, "ru/kk", {
        ...
        "topics": [
            {"title": "Бюджет проекта", "summary": "Поручено срочно подготовить бюджет к 25 сентября.", "start_segment_id": "seg-1"},
            {"title": "Отчётность и запуск пилота", "summary": "Есепті ертең жіберу керек. Запуск пилота согласован на октябрь.", "start_segment_id": "seg-2"},
        ],
        "decisions": ["Запуск пилота — в октябре."],
        "reports": [{"direction": "Финансы", "indicator": "Освоение бюджета — 68%",
                     "problem": "Подрядчики задерживают счета", "evidence": segments[3].text}],
        "tasks": [
